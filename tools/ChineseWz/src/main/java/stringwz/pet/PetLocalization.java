...
public class PetLocalization implements ChineseLocalization {
    ...
    private static final String TARGET_FILE_NAME = "Pet.img.xml";
    ...
    public void localize() {
        PetImgXml replaceByPetImgXml = PetParser.parse(REPLACE_BY);
        // 拿到所有的汉化信息
        HashMap<String, PetImgXml.Pet> replaceByCashItemMap = replaceByPetImgXml.getMapItemMap();

        PetImgXml targetEqpImgXml = PetParser.parse(REPLACE_TARGET);
