...
public class MapLocalization implements ChineseLocalization {
    ...
    private static final String TARGET_FILE_NAME = "Map.img.xml";
    ...
    public void localize() {
        MapImgXml replaceByMapImgXml = MapParser.parse(REPLACE_BY);
        // 拿到所有的汉化信息
        HashMap<String, MapImgXml.Map> replaceByCashItemMap = replaceByMapImgXml.getMapItemMap();

        MapImgXml targetEqpImgXml = MapParser.parse(REPLACE_TARGET);
