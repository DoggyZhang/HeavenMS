...
public final class Channel {
    ...
    private final Map<Integer, MapleHiredMerchant> hiredMerchants = new HashMap<>();
    private final Map<Integer, Integer> storedVars = new HashMap<>();
    private final Set<Integer> playersAway = new HashSet<>();
    private final Map<MapleExpeditionType, MapleExpedition> expeditions = new HashMap<>();
    private final Map<Integer, MapleMiniDungeon> dungeons = new HashMap<>();
    private final List<MapleExpeditionType> expedType = new ArrayList<>();
    private final Set<MapleMap> ownedMaps = Collections.synchronizedSet(Collections.newSetFromMap(new WeakHashMap<MapleMap, Boolean>()));
