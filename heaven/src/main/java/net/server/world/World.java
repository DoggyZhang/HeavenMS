...
public class World {
    ...
    private final MapleMatchCheckerCoordinator matchChecker = new MapleMatchCheckerCoordinator();
    private final MaplePartySearchCoordinator partySearch = new MaplePartySearchCoordinator();
    ...
    private final Map<Integer, SortedMap<Integer, MapleCharacter>> accountChars = new HashMap<>();
    private final Map<Integer, MapleStorage> accountStorages = new HashMap<>();
    ...
    private final Map<Integer, Pair<MapleHiredMerchant, Integer>> activeMerchants = new LinkedHashMap<>();
    ...
    private final Map<MapleCharacter, Integer> fishingAttempters = Collections.synchronizedMap(new WeakHashMap<MapleCharacter, Integer>());
